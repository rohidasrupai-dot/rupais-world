(function () {
  ...
  document.querySelector('[data-action="voice-studio"]').addEventListener('click', () => { window.location.href = 'voice-studio.html'; });
  ...
  document.querySelector('[data-action="video-lesson-builder"]').addEventListener('click', () => { window.location.href = 'video-lesson-builder.html'; });
  ...
  document.querySelector('[data-action="creator-intelligence"]').addEventListener('click', () => { window.location.href = 'creator-intelligence.html'; });
