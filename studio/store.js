(function () {
  ...
  const CURIO_EMPTY = { curioBrainRuns: [], curioBrainSnapshots: [], curioDecisions: [], curioDecisionEvidence: [], curioTeachingPlans: [], curioTeachingSteps: [], curioCoverageMatrices: [], curioReadinessAssessments: [], curioTasks: [], curioRules: [], curioRulePacks: [], curioRuleVersions: [], curioCreatorResponses: [], curioLearningProfiles: [], curioConflicts: [], curioProviderConfigurations: [], curioLearningSessions: [], curioSessionStepStates: [], curioRuntimeEvents: [], curioRuntimeLogs: [], curioRuntimeSuggestions: [], studentLearningProfiles: [], adaptiveDecisions: [], adaptiveMasteryEvidence: [], adaptiveRevisionPlans: [], studentKnowledgeProfiles: [], conceptMemories: [], knowledgeGraphs: [], knowledgeRelationships: [], revisionSchedules: [], longTermRevisionPlans: [], memoryEvents: [], studyGoals: [], learningTimeline: [], knowledgeDecayRecords: [], memoryReminders: [] };
